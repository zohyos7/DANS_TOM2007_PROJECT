...
method = 'tom2007_d_60'; % method of analysis
data_path = '/Users/zohyoonseo/tom-data/fmriprep/'; % data (1st level SPM.mat) path. DO NOT PUT '/' IN THE END!
output_path = fullfile('/Users/zohyoonseo/tom-data', method);  % output path

subjIDs_name = {'sub-01', 'sub-02', 'sub-03', 'sub-04', 'sub-05', 'sub-07', 'sub-08', 'sub-09', 'sub-10', 'sub-11', 'sub-12', 'sub-13', 'sub-14', 'sub-15', 'sub-16'};
